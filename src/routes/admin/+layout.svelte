	...
	><div class="drawer lg:drawer-open">
		...
		<div class="drawer-content">
			...
			<nav class="navbar bg-base-300 w-full">
				...
				<div class="px-4 text-lg text-black">Admin iconic-regard</div>
			</nav>
			<!-- Page content here -->
			<div class="p-4">
				<Background />
				...
				<ul class="menu w-full grow">
					...
					<li>
						...
						>
							...
							<svg
								...
								></path></svg
							>
							<span class="is-drawer-close:hidden text-lg text-white">Accueil</span>
						</button>
					</li>
					...
					<li>
						...
						>
							...
							>
							<span class="is-drawer-close:hidden text-lg text-white">Settings</span>
						</button>
					</li>
				</ul>
			</div>
