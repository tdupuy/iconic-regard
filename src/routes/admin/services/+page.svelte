	...
	<section>
		<div class="divide-base-200 flex flex-col divide-y border-t border-b sm:rounded-xl sm:border">
			<div class="flex items-center gap-3 px-1 py-2.5 sm:px-3">
				<img
					src="/assets/lash-lift-corean.webp"
				...
				<div class="min-w-0 flex-1">
					<p class="truncate text-xl font-medium">Lash lift coréen</p>
					<p class="truncate text-sm opacity-60">Durée : 60 min · Prix : 65€</p>
					<p class="truncate text-sm opacity-60">Catégorie : Soin des ciles</p>
				</div>
